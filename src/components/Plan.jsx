...
const Plan = () => {
    return (
        <div className='max-w-[1400px] m-auto py-24 px-4 grid lg:grid-cols-2 gap-4'>
            {/* Left Side */}
            ...
            <div className='flex flex-col h-full justify-center'>
                <h3 className='text-5xl md:text-6xl font-bold'>Elevate your vacation, Book your stay now</h3>
