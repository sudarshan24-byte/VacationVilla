    ...
    return (
        <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
            ...
            <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
                <p className='py-4'>VacationVilla., Sudarshan Trifaley</p>
                <div className='flex justify-between items-center sm:w-[300px] pt-4 text-2xl'>
                    <div className='hover:text-blue-600 h-fit duration-200 cursor-pointer'>
                        <FaFacebook />
                    </div>
                    <div className='hover:text-pink-600 h-fit duration-200 cursor-pointer'>
                        <FaInstagram />
                    </div>
                    <div className='hover:text-blue-800 h-fit duration-200 cursor-pointer'>
                        <FaTwitter />
                    </div>
                    <div className='hover:text-red-600 h-fit duration-200 cursor-pointer'>
                        <TiSocialPinterest size={30} />
                    </div>
                    <div className='hover:text-indigo-800 h-fit duration-200 cursor-pointer'>
                        <FaLinkedinIn />
                    </div>
                </div>
            </div>
